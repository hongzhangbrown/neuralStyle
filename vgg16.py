...
class vgg16:
    def __init__(self, imgs, weight_file = 'vgg16_weights.npz'):
        self.imgs = imgs
    ...
    def convlayers(self):
        ...
        # images = tf.Variable(self.imgs,dtype = tf.float32)
        images = self.imgs
        # conv1_1
    ...
    def load_weights(self, weight_file):
        self.parameters = dict(np.load(weight_file))
